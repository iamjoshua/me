      ...
      <nav className={styles.mainNav + ' ' + minimizedStyle}>
        ...
        <div className={styles.menu}>
          ...
          <ul className={mobileMenuStyle}>
            <li><Link activeClassName={styles.active} to="/wrote">wrote</Link></li>
            <li><Link activeClassName={styles.active} to="/read">read</Link></li>
            <li><Link activeClassName={styles.active} to="/said">said</Link></li>
          </ul>
        </div>
