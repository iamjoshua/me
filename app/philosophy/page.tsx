...
function Philosophy() {
  return (
    <main className="h-[100dvh] w-full flex justify-between">
      <div className="h-full w-full flex flex-col md:flex-row justify-end">
        <div className=" md:fixed md:top-0 md:left-0 md:h-screen w-full md:w-5/12 bg-sky-700 flex align-center items-center justify-center">
          <div className="max-w-screen-md text-center flex flex-col justify-end p-20 pb-5 md:p-10 lg:p-20">
